...
public class Premier_League {
    ...
    public static void format() throws IOException{
            ...
            for (int i=0; i < columns.size(); i++){
                ...
                if (!"top_keeper".equals(column.attr("data-stat"))) {
                    ...
                    if ("team".equals(column.attr("data-stat")) && currentWidth > team){
                        team = currentWidth;
                        if ("Club".length() > team){team = "Club".length();}
                    }

                    if ("games".equals(column.attr("data-stat")) && currentWidth > mp){
                        mp = currentWidth;
                        if ("MP".length() > mp){mp = "MP".length();}
                    }
        ...
        for (Element th: tableHeading.select("tr th")){
            ...
            switch (dsv){
                case "rank": System.out.printf("%-" +rank+ "s | ", "Rank"); break;
                case "team": System.out.printf("%-" +team+ "s | ", "Club"); break;
                case "games": System.out.printf("%-" +mp+ "s | ", "MP"); break;
                case "wins": System.out.printf("%-" +w+ "s | ", "W"); break;
                case "ties": System.out.printf("%-" +d+ "s | ", "D"); break;
                case "losses": System.out.printf("%-" +l+ "s | ", "L"); break;
                case "goals_for": System.out.printf("%-" +gf+ "s | ", "GF"); break;
                case "goals_against": System.out.printf("%-" +ga+ "s | ", "GA"); break;
                case "goal_diff": System.out.printf("%-" +gd+ "s | ", "GD"); break;
                case "points": System.out.printf("%-" +pts+ "s | ", "Pts"); break;
                case "points_avg": System.out.printf("%-" +ptsMp+ "s | ", "Pts/Mp"); break;
                case "xg_for": System.out.printf("%-" +xG+ "s | ", "xG"); break;
                case "xg_against": System.out.printf("%-" +xGA+ "s | ", "xGA"); break;
                case "xg_diff": System.out.printf("%-" +xGD+ "s | ", "xGD"); break;
                case "xg_diff_per90": System.out.printf("%-" +xGDper90+ "s | ", "xGD/90"); break;
                case "last_5": System.out.printf("%-" +last5+ "s | ", "Form"); break;
                case "attendance_per_g": System.out.printf("%-" +AttMp+ "s | ", "Att/Home-Game"); break;
                case "top_team_scorers": System.out.printf("%-" +TS+ "s | ", "Top Scorer"); break;
                case "notes": System.out.printf("%-" +note+ "s | ", "Note"); break;
